...
**Problem:** Fish had zero access to the alias/function library until v0.2.498 added bridge templates. Nushell had only 6 hardcoded aliases and no function access.
