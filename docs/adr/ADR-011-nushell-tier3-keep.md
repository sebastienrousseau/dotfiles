...
- [`dot_config/nushell/cached_eval.nu`](https://github.com/sebastienrousseau/dotfiles/blob/master/defaults/dot_config/nushell/cached_eval.nu) — the new module.
- [`dot_config/nushell/env.nu.tmpl`](https://github.com/sebastienrousseau/dotfiles/blob/master/defaults/dot_config/nushell/env.nu.tmpl) — adopter.
