...
- Sources: [`docs/manual/`](https://github.com/sebastienrousseau/dotfiles/tree/main/docs/manual) (published at [/manual/](manual/))

Quick jumps into the Manual:

- [Introduction](manual/00-introduction/) — who, what, how
- [Concepts](manual/01-concepts/01-architecture/) — architecture, trust model, theme engine, fleet, self-healing
- [Tutorials](manual/02-tutorials/01-first-install/) — first install, wallpaper→theme, profiles, secrets, fleet
- [Reference](manual/03-reference/01-dot-cli/) — CLI, config files, environment, templates, feature flags
- [Cookbook](manual/04-cookbook/01-recipes/) — 40+ recipes, troubleshooting, FAQ
