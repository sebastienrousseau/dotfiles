...
### Architecture
v0.2.491 is a portable **shell distribution** managed by `chezmoi` (source of truth in `~/.dotfiles`).
...
- **Supply chain safety**:
  - **Pinned install**: Installation commands pin to the specific release tag (`v0.2.491`) to prevent drift.
