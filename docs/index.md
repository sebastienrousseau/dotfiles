...
headline: ".dotfiles"
lead: "Cross-platform, signed, local-first dotfiles for macOS (Apple Silicon and Intel), the major Linux distributions, WSL and PowerShell 7.5 or later. One configuration across bash, zsh, fish and nushell, driven by a fast dot CLI."
cta_primary: "Install"
