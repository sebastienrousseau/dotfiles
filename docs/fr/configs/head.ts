export const head: string[] = [
  ...
  ["meta", { name: "twitter:title", content: "Dotfiles - Simply designed to fit your shell life!" }],
  ...
  ["meta", { property: "og:title", content: "Dotfiles - Simply designed to fit your shell life!" }],
