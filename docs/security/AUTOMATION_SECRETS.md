...
2. Store the matching public key in [allowed_signers](https://github.com/sebastienrousseau/dotfiles/blob/master/defaults/dot_config/git/allowed_signers.tmpl).
