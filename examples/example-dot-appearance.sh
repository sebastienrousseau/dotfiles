...
#
# Example: Themes, wallpapers and fonts
#
# Wallpaper-derived terminal themes, Nerd Font installation, OS tuning.
#
# Backing module: scripts/dot/commands/appearance.sh
...
printf '=== Themes, wallpapers and fonts ===\n\n'
...
printf '\n--- live output ---\n\n'
bash "$dot" theme current || true
bash "$dot" theme list | head -8 || true

printf '\nThemes, wallpapers and fonts example complete.\n'
