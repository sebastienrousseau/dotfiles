...
#
# Example: AI providers and the ai cockpit
#
# One verb-first surface over eighteen AI CLIs, plus cost and doctor views.
#
# Backing module: scripts/dot/commands/ai.sh
...
printf '=== AI providers and the ai cockpit ===\n\n'
...
group_commands=(ai ai-setup ai-query cl copilot kimi agy kiro sgpt ollama opencode aider)
...
printf '\n--- live output ---\n\n'
bash "$dot" ai doctor 2>&1 | head -8 || true

printf '\nAI providers and the ai cockpit example complete.\n'
