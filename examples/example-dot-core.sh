...
#
# Example: Core dotfiles operations
#
# Apply, inspect and edit the managed configuration through chezmoi.
#
# Backing module: scripts/dot/commands/core.sh
...
printf '=== Core dotfiles operations ===\n\n'
...
group_commands=(sync add diff status cd edit commit uninstall)
...
printf '\n--- live output ---\n\n'
bash "$dot" cd || true
bash "$dot" status || true

printf '\nCore dotfiles operations example complete.\n'
