...
#
# Example: Shell lint and formatting
#
# Runs ShellCheck and shfmt over every shell script in the repository.
#
# Backing module: scripts/dot/commands/lint.sh
...
printf '=== Shell lint and formatting ===\n\n'
...
printf '\n--- live output ---\n\n'
printf "  dot lint          # report\n  dot lint --check  # CI gate\n  dot lint --fix    # rewrite with shfmt\n"

printf '\nShell lint and formatting example complete.\n'
