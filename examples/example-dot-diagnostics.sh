...
#
# Example: Diagnostics and health
#
# Audit the workstation, score it, and capture evidence about its state.
#
# Backing module: scripts/dot/commands/diagnostics.sh
...
printf '\n--- live output ---\n\n'
bash "$dot" locks | head -12 || true
bash "$dot" drift --json || true

printf '\nDiagnostics and health example complete.\n'
