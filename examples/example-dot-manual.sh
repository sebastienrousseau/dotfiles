...
#
# Example: The dotfiles manual
#
# Open or download the manual as HTML, PDF, EPUB, plain text or Markdown.
#
# Backing module: scripts/dot/commands/manual.sh
...
printf '\n--- live output ---\n\n'
mkdir -p "$XDG_DATA_HOME/dotfiles/manual"
printf "Offline manual body.\n" >"$XDG_DATA_HOME/dotfiles/manual/dotfiles.txt"
bash "$dot" manual text --offline || true

printf '\nThe dotfiles manual example complete.\n'
