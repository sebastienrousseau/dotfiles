...
#
# Example: Reusable module registry
#
# Browse and install verified dotfile modules; every archive is sha256-checked.
#
# Backing module: scripts/dot/commands/registry.sh
...
printf '=== Reusable module registry ===\n\n'
...
printf '\n--- live output ---\n\n'
bash "$dot" registry url || true
bash "$dot" registry --help | head -8 || true

printf '\nReusable module registry example complete.\n'
