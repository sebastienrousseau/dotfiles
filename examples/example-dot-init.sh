...
#
# Example: Bootstrapping a foreign dotfiles repo
#
# Clone and apply someone else'\''s dotfiles through chezmoi and the dot harness.
#
# Backing module: scripts/dot/commands/init.sh
...
printf '=== Bootstrapping a foreign dotfiles repo ===\n\n'
...
printf '\n--- live output ---\n\n'
bash "$dot" init alice --dry-run || true
bash "$dot" init alice/configs --dry-run --no-apply || true

printf '\nBootstrapping a foreign dotfiles repo example complete.\n'
