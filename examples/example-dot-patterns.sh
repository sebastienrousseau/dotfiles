...
#
# Example: AI steering patterns
#
# List, view and edit the steering patterns the AI bridges apply.
#
# Backing module: scripts/dot/commands/patterns.sh
...
printf "# demo pattern\n" >"$XDG_CONFIG_HOME/ai/patterns/example.md"
bash "$dot" patterns list || true

printf '\nAI steering patterns example complete.\n'
