...
#
# Example: Multi-harness agent context
#
# Keep AGENTS.md and ten harness config files in sync with CLAUDE.md.
#
# Backing module: scripts/dot/commands/agents.sh
...
printf '=== Multi-harness agent context ===\n\n'
...
printf '\n--- live output ---\n\n'
bash "$dot" agents --help | head -8 || true

printf '\nMulti-harness agent context example complete.\n'
