...
#
# Example: Agent modes and checkpoints
#
# Bounded-autonomy profiles, RBAC, run checkpoints and the A2A agent card.
#
# Backing module: scripts/dot/commands/agent.sh
...
printf '=== Agent modes and checkpoints ===\n\n'
...
printf '\n--- live output ---\n\n'
bash "$dot" mode list || true
bash "$dot" agent card 2>&1 | head -6 || true

printf '\nAgent modes and checkpoints example complete.\n'
