...
#
# Example: Shell alias catalogue
#
# List, search, explain and audit every alias the dotfiles ship.
#
# Backing module: scripts/dot/commands/aliases.sh
...
printf '\n--- live output ---\n\n'
bash "$dot" aliases tiers | head -10 || true

printf '\nShell alias catalogue example complete.\n'
