...
#
# Example: Toolchain, profiles and project scaffolding
#
# Managed tool versions via mise, configuration profiles, and new projects.
#
# Backing module: scripts/dot/commands/tools.sh
...
printf '=== Toolchain, profiles and project scaffolding ===\n\n'
...
group_commands=(env profile tools new packages)
...
printf '\n--- live output ---\n\n'
bash "$dot" profile show | head -8 || true

printf '\nToolchain, profiles and project scaffolding example complete.\n'
