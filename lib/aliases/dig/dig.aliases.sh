...
if command -v dig &>/dev/null; then
  ...
  alias digg='$(which dig) @8.8.8.8 +nocmd any +multiline +noall \
  +answer'

  # ip4: Get your public IPv4 address.
  alias ip4='$(which dig) +short myip.opendns.com \
           @resolver1.opendns.com -4'

  # ip6: Get your public IPv6 address.
  alias ip6='$(which dig) -6 AAAA +short myip.opendns.com. \
  ...
  alias wip='$(which dig) +short myip.opendns.com \
           @resolver1.opendns.com'
