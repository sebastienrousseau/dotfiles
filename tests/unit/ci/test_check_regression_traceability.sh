...
# Tests for scripts/ci/check-regression-traceability.sh — enforces
...
SCRIPT_FILE="$REPO_ROOT/scripts/ci/check-regression-traceability.sh"

trap cov_teardown_sandbox EXIT
cov_setup_sandbox

test_start "script_exists"
assert_file_exists "$SCRIPT_FILE" "scripts/ci/check-regression-traceability.sh must exist"
