...
# Tests for tools/ci/dot-cli-startup-bench.sh — sub-100ms CLI
...
SCRIPT_FILE="$REPO_ROOT/tools/ci/dot-cli-startup-bench.sh"

trap cov_teardown_sandbox EXIT
cov_setup_sandbox

test_start "script_exists"
assert_file_exists "$SCRIPT_FILE" "tools/ci/dot-cli-startup-bench.sh must exist"
