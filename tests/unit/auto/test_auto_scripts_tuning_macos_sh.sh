...
# Auto-generated exercise test for scripts/tuning/macos.sh.
...
SCRIPT_FILE="$REPO_ROOT/scripts/tuning/macos.sh"

trap cov_teardown_sandbox EXIT
cov_setup_sandbox

test_start "script_exists"
assert_file_exists "$SCRIPT_FILE" "scripts/tuning/macos.sh must exist"
