...
# Auto-generated exercise test for scripts/security/ssh-cert.sh.
...
SCRIPT_FILE="$REPO_ROOT/scripts/security/ssh-cert.sh"

trap cov_teardown_sandbox EXIT
cov_setup_sandbox

test_start "script_exists"
assert_file_exists "$SCRIPT_FILE" "scripts/security/ssh-cert.sh must exist"
