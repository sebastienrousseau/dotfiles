...
# Auto-generated exercise test for scripts/dot/lib/ui.sh.
...
SCRIPT_FILE="$REPO_ROOT/scripts/dot/lib/ui.sh"

trap cov_teardown_sandbox EXIT
cov_setup_sandbox

test_start "script_exists"
assert_file_exists "$SCRIPT_FILE" "scripts/dot/lib/ui.sh must exist"
