...
# Auto-generated exercise test for .chezmoitemplates/functions/misc/caffeine.sh.
...
SCRIPT_FILE="$REPO_ROOT/defaults/.chezmoitemplates/functions/misc/caffeine.sh"

trap cov_teardown_sandbox EXIT
cov_setup_sandbox

test_start "script_exists"
assert_file_exists "$SCRIPT_FILE" ".chezmoitemplates/functions/misc/caffeine.sh must exist"
