...
# Auto-generated exercise test for .chezmoitemplates/functions/misc/view-source.sh.
...
SCRIPT_FILE="$REPO_ROOT/defaults/.chezmoitemplates/functions/misc/view-source.sh"

trap cov_teardown_sandbox EXIT
cov_setup_sandbox

test_start "script_exists"
assert_file_exists "$SCRIPT_FILE" ".chezmoitemplates/functions/misc/view-source.sh must exist"
