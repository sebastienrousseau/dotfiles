...
# Auto-generated exercise test for .chezmoitemplates/functions/security/keygen.sh.
...
assert_file_exists "$SCRIPT_FILE" ".chezmoitemplates/functions/security/keygen.sh must exist"
