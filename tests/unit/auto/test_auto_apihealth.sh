...
# Auto-generated exercise test for .chezmoitemplates/functions/api/apihealth.sh.
...
SCRIPT_FILE="$REPO_ROOT/defaults/.chezmoitemplates/functions/api/apihealth.sh"

trap cov_teardown_sandbox EXIT
cov_setup_sandbox

test_start "script_exists"
assert_file_exists "$SCRIPT_FILE" ".chezmoitemplates/functions/api/apihealth.sh must exist"
