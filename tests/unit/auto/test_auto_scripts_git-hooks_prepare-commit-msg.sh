...
# Auto-generated exercise test for scripts/git-hooks/prepare-commit-msg.
...
SCRIPT_FILE="$REPO_ROOT/scripts/git-hooks/prepare-commit-msg"

trap cov_teardown_sandbox EXIT
cov_setup_sandbox

test_start "script_exists"
assert_file_exists "$SCRIPT_FILE" "scripts/git-hooks/prepare-commit-msg must exist"
