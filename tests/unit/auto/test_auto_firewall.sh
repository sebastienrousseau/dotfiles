...
# Auto-generated exercise test for scripts/security/firewall.sh.
...
SCRIPT_FILE="$REPO_ROOT/scripts/security/firewall.sh"

trap cov_teardown_sandbox EXIT
cov_setup_sandbox

test_start "script_exists"
assert_file_exists "$SCRIPT_FILE" "scripts/security/firewall.sh must exist"
