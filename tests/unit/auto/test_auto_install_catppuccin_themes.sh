...
# Auto-generated exercise test for scripts/theme/install-catppuccin-themes.sh.
...
SCRIPT_FILE="$REPO_ROOT/scripts/theme/install-catppuccin-themes.sh"

trap cov_teardown_sandbox EXIT
cov_setup_sandbox

test_start "script_exists"
assert_file_exists "$SCRIPT_FILE" "scripts/theme/install-catppuccin-themes.sh must exist"
