...
# Auto-generated exercise test for scripts/dot/commands/restore.sh.
...
SCRIPT_FILE="$REPO_ROOT/scripts/dot/commands/restore.sh"

trap cov_teardown_sandbox EXIT
cov_setup_sandbox

test_start "script_exists"
assert_file_exists "$SCRIPT_FILE" "scripts/dot/commands/restore.sh must exist"
