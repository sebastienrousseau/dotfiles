...
# Auto-generated exercise test for scripts/git-hooks/install.sh.
...
SCRIPT_FILE="$REPO_ROOT/scripts/git-hooks/install.sh"

trap cov_teardown_sandbox EXIT
cov_setup_sandbox

test_start "script_exists"
assert_file_exists "$SCRIPT_FILE" "scripts/git-hooks/install.sh must exist"
