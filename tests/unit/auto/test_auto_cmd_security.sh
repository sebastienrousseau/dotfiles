...
# Auto-generated function-exercise test for scripts/dot/commands/security.sh.
...
SCRIPT_FILE="$REPO_ROOT/scripts/dot/commands/security.sh"

trap cov_teardown_sandbox EXIT
cov_setup_sandbox

test_start "script_exists"
assert_file_exists "$SCRIPT_FILE" "scripts/dot/commands/security.sh must exist"
