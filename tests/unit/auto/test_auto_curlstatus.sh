...
# Auto-generated exercise test for .chezmoitemplates/functions/curl/curlstatus.sh.
...
SCRIPT_FILE="$REPO_ROOT/defaults/.chezmoitemplates/functions/curl/curlstatus.sh"

trap cov_teardown_sandbox EXIT
cov_setup_sandbox

test_start "script_exists"
assert_file_exists "$SCRIPT_FILE" ".chezmoitemplates/functions/curl/curlstatus.sh must exist"
