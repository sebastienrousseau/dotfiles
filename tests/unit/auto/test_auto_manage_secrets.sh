...
# Auto-generated exercise test for scripts/security/manage-secrets.sh.
...
SCRIPT_FILE="$REPO_ROOT/scripts/security/manage-secrets.sh"

trap cov_teardown_sandbox EXIT
cov_setup_sandbox

test_start "script_exists"
assert_file_exists "$SCRIPT_FILE" "scripts/security/manage-secrets.sh must exist"
