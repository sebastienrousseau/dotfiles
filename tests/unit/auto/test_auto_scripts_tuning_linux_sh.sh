...
# Auto-generated exercise test for scripts/tuning/linux.sh.
...
SCRIPT_FILE="$REPO_ROOT/scripts/tuning/linux.sh"

trap cov_teardown_sandbox EXIT
cov_setup_sandbox

test_start "script_exists"
assert_file_exists "$SCRIPT_FILE" "scripts/tuning/linux.sh must exist"
