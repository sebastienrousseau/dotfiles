...
# Auto-generated exercise test for dot_local/bin/executable_yamlv.
...
SCRIPT_FILE="$REPO_ROOT/defaults/dot_local/bin/executable_yamlv"

trap cov_teardown_sandbox EXIT
cov_setup_sandbox

test_start "script_exists"
assert_file_exists "$SCRIPT_FILE" "dot_local/bin/executable_yamlv must exist"
