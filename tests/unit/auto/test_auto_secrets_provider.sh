...
# Auto-generated exercise test for scripts/lib/secrets_provider.sh.
...
SCRIPT_FILE="$REPO_ROOT/scripts/lib/secrets_provider.sh"

trap cov_teardown_sandbox EXIT
cov_setup_sandbox

test_start "script_exists"
assert_file_exists "$SCRIPT_FILE" "scripts/lib/secrets_provider.sh must exist"
