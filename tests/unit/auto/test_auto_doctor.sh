...
# Auto-generated exercise test for scripts/diagnostics/doctor.sh.
...
SCRIPT_FILE="$REPO_ROOT/scripts/diagnostics/doctor.sh"

trap cov_teardown_sandbox EXIT
cov_setup_sandbox

test_start "script_exists"
assert_file_exists "$SCRIPT_FILE" "scripts/diagnostics/doctor.sh must exist"
