...
# Auto-generated exercise test for scripts/git-hooks/pre-commit.
...
SCRIPT_FILE="$REPO_ROOT/scripts/git-hooks/pre-commit"

trap cov_teardown_sandbox EXIT
cov_setup_sandbox

test_start "script_exists"
assert_file_exists "$SCRIPT_FILE" "scripts/git-hooks/pre-commit must exist"
