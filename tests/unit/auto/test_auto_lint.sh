...
# Auto-generated exercise test for scripts/dot/commands/lint.sh.
...
SCRIPT_FILE="$REPO_ROOT/scripts/dot/commands/lint.sh"

trap cov_teardown_sandbox EXIT
cov_setup_sandbox

test_start "script_exists"
assert_file_exists "$SCRIPT_FILE" "scripts/dot/commands/lint.sh must exist"
