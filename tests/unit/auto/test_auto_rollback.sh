...
# Auto-generated exercise test for scripts/ops/rollback.sh.
...
SCRIPT_FILE="$REPO_ROOT/scripts/ops/rollback.sh"

trap cov_teardown_sandbox EXIT
cov_setup_sandbox

test_start "script_exists"
assert_file_exists "$SCRIPT_FILE" "scripts/ops/rollback.sh must exist"
