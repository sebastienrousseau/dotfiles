...
# Auto-generated exercise test for scripts/qa/traceability-coverage.sh.
...
SCRIPT_FILE="$REPO_ROOT/scripts/qa/traceability-coverage.sh"

trap cov_teardown_sandbox EXIT
cov_setup_sandbox

test_start "script_exists"
assert_file_exists "$SCRIPT_FILE" "scripts/qa/traceability-coverage.sh must exist"
