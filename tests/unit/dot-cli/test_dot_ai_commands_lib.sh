...
called "ollama run qwen3.5:4b"
DOTFILES_OLLAMA_MODEL="custom-model:small" ai _ai_invoke_provider ollama "hello"
called "ollama run custom-model:small"
ai _ai_invoke_provider opencode "hello"
called "opencode run hello"
ai _ai_invoke_provider aider "hello"
called "aider --message hello"
ai _ai_invoke_provider vibe "hello"
called "vibe --prompt hello"
ai _ai_invoke_provider qwen "hello"
called "qwen --prompt hello"
ai _ai_invoke_provider zai "hello"
called "zai --prompt hello"
ai _ai_invoke_provider autohand "hello"
called "autohand --prompt hello"
...
# ── serve ───────────────────────────────────────────────────────────────
test_start "chat_ollama_uses_the_configured_local_model"
ai cmd_ai_chat ollama
assert_equals 0 "$RC" "rc"
called "ollama run qwen3.5:4b"
DOTFILES_OLLAMA_MODEL="custom-model:small" ai cmd_ai_chat ollama
called "ollama run custom-model:small"
