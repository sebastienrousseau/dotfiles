...
ALIAS_FILE="$REPO_ROOT/defaults/.chezmoitemplates/aliases/cd/cd-init.aliases.sh"

test_start "cd_init_file_exists"
assert_file_exists "$ALIAS_FILE" "cd-init.aliases.sh should exist"

test_start "cd_init_valid_syntax"
...
test_start "cd_init_defines_content"
