...
ALIAS_FILE="$REPO_ROOT/defaults/.chezmoitemplates/aliases/cd/cd-completion.aliases.sh"

test_start "cd_completion_file_exists"
assert_file_exists "$ALIAS_FILE" "cd/cd-completion.aliases.sh should exist"

test_start "cd_completion_valid_syntax"
...
test_start "cd_completion_defines_content"
