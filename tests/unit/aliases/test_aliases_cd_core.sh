...
ALIAS_FILE="$REPO_ROOT/defaults/.chezmoitemplates/aliases/cd/cd-core.aliases.sh"

test_start "cd_core_file_exists"
assert_file_exists "$ALIAS_FILE" "cd-core.aliases.sh should exist"

test_start "cd_core_valid_syntax"
...
test_start "cd_core_defines_content"
