...
CURLSTATUS_FN="$REPO_ROOT/.chezmoitemplates/functions/curl/curlstatus.sh"
CURLTIME_FN="$REPO_ROOT/.chezmoitemplates/functions/curl/curltime.sh"
CURLHEADER_FN="$REPO_ROOT/.chezmoitemplates/functions/curl/curlheader.sh"
