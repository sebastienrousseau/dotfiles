...
ALIAS_FILE="$REPO_ROOT/defaults/.chezmoitemplates/aliases/macOS/vscode.aliases.sh"

test_start "vscode_file_exists"
assert_file_exists "$ALIAS_FILE" "vscode.aliases.sh should exist"

test_start "vscode_valid_syntax"
...
test_start "vscode_defines_content"
