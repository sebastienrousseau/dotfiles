...
ALIAS_FILE="$REPO_ROOT/defaults/.chezmoitemplates/aliases/cd/cd-stack.aliases.sh"

test_start "cd_stack_file_exists"
assert_file_exists "$ALIAS_FILE" "cd-stack.aliases.sh should exist"

test_start "cd_stack_valid_syntax"
...
test_start "cd_stack_defines_content"
