...
ALIAS_FILE="$REPO_ROOT/defaults/.chezmoitemplates/aliases/cd/cd-utils.aliases.sh"

test_start "cd_utils_file_exists"
assert_file_exists "$ALIAS_FILE" "cd/cd-utils.aliases.sh should exist"

test_start "cd_utils_valid_syntax"
...
test_start "cd_utils_defines_content"
