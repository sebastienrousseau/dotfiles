...
ALIAS_FILE="$REPO_ROOT/defaults/.chezmoitemplates/aliases/cd/cd-help.aliases.sh"

test_start "cd_help_file_exists"
assert_file_exists "$ALIAS_FILE" "cd-help.aliases.sh should exist"

test_start "cd_help_valid_syntax"
...
test_start "cd_help_defines_content"
