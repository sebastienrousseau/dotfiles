...
TARGET="$REPO_ROOT/defaults/dot_config/nvim/lua/plugins/markdown.lua"

test_start "nvim_plugin_markdown_exists"
assert_file_exists "$TARGET" "markdown.lua should exist"
