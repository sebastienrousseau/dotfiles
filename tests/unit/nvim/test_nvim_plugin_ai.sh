...
TARGET="$REPO_ROOT/defaults/dot_config/nvim/lua/plugins/ai.lua"

test_start "nvim_plugin_ai_exists"
assert_file_exists "$TARGET" "ai.lua should exist"

test_start "nvim_plugin_ai_not_empty"
if [[ -s "$TARGET" ]]; then
  ((TESTS_PASSED++))
...
test_start "nvim_plugin_ai_valid_lua"
...
test_start "nvim_plugin_ai_returns_table"
