...
TARGET="$REPO_ROOT/defaults/dot_config/nvim/lua/plugins/editor.lua"

test_start "nvim_plugin_editor_exists"
assert_file_exists "$TARGET" "editor.lua should exist"

test_start "nvim_plugin_editor_not_empty"
if [[ -s "$TARGET" ]]; then
  ((TESTS_PASSED++))
...
test_start "nvim_plugin_editor_valid_lua"
...
test_start "nvim_plugin_editor_returns_table"
