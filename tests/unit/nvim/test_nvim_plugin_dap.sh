...
TARGET="$REPO_ROOT/defaults/dot_config/nvim/lua/plugins/dap.lua"

test_start "nvim_plugin_dap_exists"
assert_file_exists "$TARGET" "dap.lua should exist"

test_start "nvim_plugin_dap_not_empty"
if [[ -s "$TARGET" ]]; then
  ((TESTS_PASSED++))
...
test_start "nvim_plugin_dap_valid_lua"
...
test_start "nvim_plugin_dap_returns_table"
