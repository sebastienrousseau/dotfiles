...
FISH_FUNC="$REPO_ROOT/dot_config/fish/functions/fisher.fish"

test_start "fish_fisher_exists"
assert_file_exists "$FISH_FUNC" "fisher.fish should exist"

test_start "fish_fisher_not_empty"
if [[ -s "$FISH_FUNC" ]]; then
  ((TESTS_PASSED++))
...
test_start "fish_fisher_valid_syntax"
