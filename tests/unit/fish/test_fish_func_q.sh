...
FISH_FUNC="$REPO_ROOT/defaults/dot_config/fish/functions/q.fish"

test_start "fish_q_exists"
assert_file_exists "$FISH_FUNC" "q.fish should exist"

test_start "fish_q_not_empty"
if [[ -s "$FISH_FUNC" ]]; then
  ((TESTS_PASSED++))
...
test_start "fish_q_valid_syntax"
