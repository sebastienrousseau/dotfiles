...
FISH_FUNC="$REPO_ROOT/defaults/dot_config/fish/functions/c.fish"

test_start "fish_c_exists"
assert_file_exists "$FISH_FUNC" "c.fish should exist"

test_start "fish_c_not_empty"
if [[ -s "$FISH_FUNC" ]]; then
  ((TESTS_PASSED++))
...
test_start "fish_c_valid_syntax"
