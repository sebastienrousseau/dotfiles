...
FISH_FUNC="$REPO_ROOT/defaults/dot_config/fish/functions/l.fish"

test_start "fish_l_exists"
assert_file_exists "$FISH_FUNC" "l.fish should exist"

test_start "fish_l_not_empty"
if [[ -s "$FISH_FUNC" ]]; then
  ((TESTS_PASSED++))
...
test_start "fish_l_valid_syntax"
