...
FISH_FUNC="$REPO_ROOT/defaults/dot_config/fish/functions/_.fish"

test_start "fish_underscore_exists"
assert_file_exists "$FISH_FUNC" "_.fish should exist"

test_start "fish_underscore_not_empty"
if [[ -s "$FISH_FUNC" ]]; then
  ((TESTS_PASSED++))
...
test_start "fish_underscore_valid_syntax"
