...
FISH_FUNC="$REPO_ROOT/defaults/dot_config/fish/functions/log_info.fish"

test_start "fish_log_info_exists"
assert_file_exists "$FISH_FUNC" "log_info.fish should exist"

test_start "fish_log_info_not_empty"
if [[ -s "$FISH_FUNC" ]]; then
  ((TESTS_PASSED++))
...
test_start "fish_log_info_valid_syntax"
