...
FISH_FUNC="$REPO_ROOT/defaults/dot_config/fish/functions/lra.fish"

test_start "fish_lra_exists"
assert_file_exists "$FISH_FUNC" "lra.fish should exist"

test_start "fish_lra_not_empty"
if [[ -s "$FISH_FUNC" ]]; then
  ((TESTS_PASSED++))
...
test_start "fish_lra_valid_syntax"
