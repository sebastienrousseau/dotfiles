...
FISH_FUNC="$REPO_ROOT/defaults/dot_config/fish/functions/ls.fish"

test_start "fish_ls_exists"
assert_file_exists "$FISH_FUNC" "ls.fish should exist"

test_start "fish_ls_not_empty"
if [[ -s "$FISH_FUNC" ]]; then
  ((TESTS_PASSED++))
...
test_start "fish_ls_valid_syntax"
