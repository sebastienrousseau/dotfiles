...
FISH_FUNC="$REPO_ROOT/defaults/dot_config/fish/functions/la.fish"

test_start "fish_la_exists"
assert_file_exists "$FISH_FUNC" "la.fish should exist"

test_start "fish_la_not_empty"
if [[ -s "$FISH_FUNC" ]]; then
  ((TESTS_PASSED++))
...
test_start "fish_la_valid_syntax"
