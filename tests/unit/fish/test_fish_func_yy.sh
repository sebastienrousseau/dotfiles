...
FISH_FUNC="$REPO_ROOT/defaults/dot_config/fish/functions/yy.fish"

test_start "fish_yy_exists"
assert_file_exists "$FISH_FUNC" "yy.fish should exist"

test_start "fish_yy_not_empty"
if [[ -s "$FISH_FUNC" ]]; then
  ((TESTS_PASSED++))
...
test_start "fish_yy_valid_syntax"
