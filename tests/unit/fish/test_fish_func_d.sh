...
FISH_FUNC="$REPO_ROOT/defaults/dot_config/fish/functions/d.fish"

test_start "fish_d_exists"
assert_file_exists "$FISH_FUNC" "d.fish should exist"

test_start "fish_d_not_empty"
if [[ -s "$FISH_FUNC" ]]; then
  ((TESTS_PASSED++))
...
test_start "fish_d_valid_syntax"
