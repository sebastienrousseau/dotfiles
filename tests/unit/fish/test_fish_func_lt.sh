...
FISH_FUNC="$REPO_ROOT/defaults/dot_config/fish/functions/lt.fish"

test_start "fish_lt_exists"
assert_file_exists "$FISH_FUNC" "lt.fish should exist"

test_start "fish_lt_not_empty"
if [[ -s "$FISH_FUNC" ]]; then
  ((TESTS_PASSED++))
...
test_start "fish_lt_valid_syntax"
