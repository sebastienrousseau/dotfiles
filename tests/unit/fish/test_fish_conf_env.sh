...
CONF_FILE="$REPO_ROOT/defaults/dot_config/fish/conf.d/env.fish.tmpl"

test_start "fish_conf_env_exists"
assert_file_exists "$CONF_FILE" "env.fish.tmpl should exist"

test_start "fish_conf_env_not_empty"
if [[ -s "$CONF_FILE" ]]; then
  ((TESTS_PASSED++))
...
test_start "fish_conf_env_no_bash_syntax"
