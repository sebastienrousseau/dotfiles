...
FISH_FUNC="$REPO_ROOT/defaults/dot_config/fish/functions/dot.fish"

test_start "fish_dot_exists"
assert_file_exists "$FISH_FUNC" "dot.fish should exist"

test_start "fish_dot_not_empty"
if [[ -s "$FISH_FUNC" ]]; then
  ((TESTS_PASSED++))
...
test_start "fish_dot_valid_syntax"
