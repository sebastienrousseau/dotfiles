...
FISH_FUNC="$REPO_ROOT/defaults/dot_config/fish/functions/ll.fish"

test_start "fish_ll_exists"
assert_file_exists "$FISH_FUNC" "ll.fish should exist"

test_start "fish_ll_not_empty"
if [[ -s "$FISH_FUNC" ]]; then
  ((TESTS_PASSED++))
...
test_start "fish_ll_valid_syntax"
