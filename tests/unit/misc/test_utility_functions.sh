...
if [[ -f "$FUNCS_DIR/system/hostinfo.sh" ]]; then
  source "$FUNCS_DIR/system/hostinfo.sh"
fi
...
if [[ -f "$FUNCS_DIR/files/size.sh" ]]; then
  source "$FUNCS_DIR/files/size.sh"
fi
...
if [[ -f "$FUNCS_DIR/interactive/banner.sh" ]]; then
  source "$FUNCS_DIR/interactive/banner.sh"
fi
