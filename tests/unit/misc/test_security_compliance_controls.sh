...
gitconfig_template="$REPO_ROOT/defaults/dot_gitconfig.tmpl"
...
policy_release_script="$REPO_ROOT/tools/release/package-policy-bundles.sh"
package_managers_lib="$REPO_ROOT/install/lib/package_managers.sh"
allowed_signers_file="$REPO_ROOT/defaults/dot_config/git/allowed_signers.tmpl"
