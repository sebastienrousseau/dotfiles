...
curl -fsSL -o /tmp/dotfiles-install.sh \
  https://github.com/sebastienrousseau/dotfiles/releases/download/v0.2.523/dotfiles-install-0.2.523.sh
if command -v sha256sum >/dev/null 2>&1; then
  echo "6e01971dc11493a4738a8058f8ecc0942c181d2b4b70da59d536400482fbba32  /tmp/dotfiles-install.sh" | sha256sum -c -
else
  echo "6e01971dc11493a4738a8058f8ecc0942c181d2b4b70da59d536400482fbba32  /tmp/dotfiles-install.sh" | shasum -a 256 -c -
fi
...
```bash
gh release download v0.2.523 --repo sebastienrousseau/dotfiles --pattern 'dot-*.tar.gz'
gh attestation verify dot-0.2.523.tar.gz --repo sebastienrousseau/dotfiles
tar -xzf dot-0.2.523.tar.gz
make -C dot-0.2.523 install PREFIX=/usr/local
```
