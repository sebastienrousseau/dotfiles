...
TEST_SCRIPT="$REPO_ROOT/scripts/diagnostics/snapshot.sh"

test_start "snapshot_exists"
assert_file_exists "$TEST_SCRIPT" "snapshot.sh should exist"

test_start "snapshot_syntax"
