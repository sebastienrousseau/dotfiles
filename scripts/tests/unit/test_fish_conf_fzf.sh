...
CONF_FILE="$REPO_ROOT/dot_config/fish/conf.d/fzf.fish.tmpl"

test_start "fish_conf_fzf_exists"
assert_file_exists "$CONF_FILE" "fzf.fish.tmpl should exist"

test_start "fish_conf_fzf_not_empty"
if [[ -s "$CONF_FILE" ]]; then
...
test_start "fish_conf_fzf_no_bash_syntax"
