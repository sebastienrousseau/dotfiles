...
TEST_SCRIPT="$REPO_ROOT/scripts/diagnostics/secret-governance.sh"

test_start "secret_governance_exists"
assert_file_exists "$TEST_SCRIPT" "secret-governance.sh should exist"

test_start "secret_governance_syntax"
