...
TEST_SCRIPT="$REPO_ROOT/scripts/diagnostics/conflicts.sh"

test_start "conflicts_exists"
assert_file_exists "$TEST_SCRIPT" "conflicts.sh should exist"

test_start "conflicts_syntax"
