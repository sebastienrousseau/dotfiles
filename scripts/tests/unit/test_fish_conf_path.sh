...
CONF_FILE="$REPO_ROOT/dot_config/fish/conf.d/path.fish.tmpl"

test_start "fish_conf_path_exists"
assert_file_exists "$CONF_FILE" "path.fish.tmpl should exist"

test_start "fish_conf_path_not_empty"
if [[ -s "$CONF_FILE" ]]; then
...
test_start "fish_conf_path_no_bash_syntax"
