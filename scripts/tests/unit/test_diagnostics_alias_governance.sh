...
TEST_SCRIPT="$REPO_ROOT/scripts/diagnostics/alias-governance.sh"

test_start "alias_governance_exists"
assert_file_exists "$TEST_SCRIPT" "alias-governance.sh should exist"
...
test_start "alias_governance_shebang"
