...
ALIAS_FILE="$REPO_ROOT/.chezmoitemplates/aliases/macOS/macos.aliases.sh"

test_start "macos_file_exists"
assert_file_exists "$ALIAS_FILE" "macos.aliases.sh should exist"

test_start "macos_valid_syntax"
...
test_start "macos_defines_content"
