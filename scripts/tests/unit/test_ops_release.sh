...
TEST_SCRIPT="$REPO_ROOT/scripts/ops/release.sh"

test_start "release_exists"
assert_file_exists "$TEST_SCRIPT" "release.sh should exist"

test_start "release_syntax"
