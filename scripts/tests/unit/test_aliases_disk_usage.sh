...
ALIAS_FILE="$REPO_ROOT/.chezmoitemplates/aliases/disk-usage/du.aliases.sh"

test_start "disk_usage_file_exists"
assert_file_exists "$ALIAS_FILE" "du.aliases.sh should exist"
