...
TEST_SCRIPT="$REPO_ROOT/scripts/diagnostics/scorecard.sh"

test_start "scorecard_exists"
assert_file_exists "$TEST_SCRIPT" "scorecard.sh should exist"

test_start "scorecard_syntax"
